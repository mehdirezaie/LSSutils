...
samples="mainlinp" # options are lowmidhighz mainhighz
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_linp_${map}/hp/
                echo ${output_path}
                python $nnfit -i ${input_path} -o ${output_path} -ax ${axes} -fl --loss pnll --model linp
            done
        done
    done
fi
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_linp_${map}
                echo ${output_path}
                python $nnfit -i ${input_path} -o ${output_path} -ax ${axes} -lr ${lr} --nn_structure ${nn_structure[@]} -ne $nepoch -nc $nchains -k --loss pnll --model linp
            done
        done
    done
fi
...
then
    ...
    do
        ...
        do
            ...
            python $swap -m ${map} -n ${nside} -s main linp -c ${cap} --method nn_linp
