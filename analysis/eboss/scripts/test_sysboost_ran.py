...
if __name__ == '__main__':
    ...
    ran_org = '/home/mehdi/data/eboss/mocks/syst_boost_ran/EZmock_eBOSS_QSO_NGC_v7_noweight_0001.ran.fits'
    ran = EbossCat(ran_org, kind='randoms', zmin=0.8, zmax=3.5)
    ...
    for sys_name, sys_axis in sys_axes.items():
        ...
        for bf in boost_factors:
            ...
            p = '/home/mehdi/data/eboss/mocks/syst_boost_ran/'
            ran_name = f'{p}EZmock_eBOSS_QSO_known_{sys_name}_{bf:.1f}_NGC_v7_noweight_0001.ran.fits'
            print(ran_name)
