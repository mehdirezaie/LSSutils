...
slices="main linstar" #"low mid" #"main highz" # options are "main highz low mid z1 z2 z3"
maps="known" # options are "all known" but known is enough
samples="mainlinstar" # options are lowmidhighz mainhighz / only 1: mainlinmse mainlinp mainmse mainhighz mainwocos mainstar mainstarg mainlinstar
    ...
    do
        ...
        do
            ...
            do
                ...
                axes=$(get_axes ${map})
                output_path=${input_dir}lin_star_${map}
...
then
    ...
    do
        ...
        do
            ...
            python $swap -m ${map} -n ${nside} -s ${slices} -c ${cap} -v ${release} --method lin_star # 1+1 z
