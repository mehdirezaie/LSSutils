...
samples="mainwocos" # options are lowmidhighz mainhighz
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_pnllwocos_${map}/hp/
                echo ${output_path}
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_pnllwocos_${map}
                echo ${output_path}
                python $nnfit -i ${input_path} -o ${output_path} -ax ${axes} -lr ${lr} --nn_structure ${nn_structure[@]} -ne $nepoch -nc $nchains -k --scheduler none
            done
        done
    done
fi
...
then
    ...
    do
        ...
        do
            ...
            python $swap -m ${map} -n ${nside} -s main wocos -c ${cap} --method nn_pnllwocos
        done
    done
fi
