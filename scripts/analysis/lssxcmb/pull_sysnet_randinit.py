...
metrics = np.load(f'/home/mehdi/data/tanveer/elg_mse/metrics.npz', allow_pickle=True)
...
for p in range(nfolds):
    ...
    chcks = glob(f'/home/mehdi/data/tanveer/elg_mse/model_{p}_*/best.pth.tar')
...
dt.write('/home/mehdi/data/tanveer/elg_mse/nn-weights-combined.fits', format='fits')
