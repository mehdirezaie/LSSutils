    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_mse_${map}/hp/
                echo ${output_path}
                python $nnfit -i ${input_path} -o ${output_path} -ax ${axes} -fl --loss mse --model dnn
            done
        done
    done
fi
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_mse_${map}
                echo ${output_path}
                python $nnfit -i ${input_path} -o ${output_path} -ax ${axes} -lr ${lr} --nn_structure ${nn_structure[@]} -ne $nepoch -nc $nchains -k --loss mse --model dnn
            done
        done
    done
fi
