...
samples="mainstar" # options are lowmidhighz mainhighz
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_pnllwnstar_${map}/hp/
                echo ${output_path}
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_pnllwnstar_${map}
                echo ${output_path}
...
then
    ...
    do
        ...
        do
            ...
            python $swap -m ${map} -n ${nside} -s main star -c ${cap} --method nn_pnllwnstar
        done
    done
fi
