...
#  'run', 'airmass'
axes_all=({0..16})
axes_known=(0 1 5 7 13) # nstar ebv, depth-g, psf-i sky-i
nepoch=150
nchains=20
version="v7_2"
release="1.0"
...
samples="mainstarg" # options are lowmidhighz mainhighz
table_name="ngal_ebossgaia"
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_pnllwnstarg_${map}/hp/
                echo ${output_path}
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_pnllwnstarg_${map}
                echo ${output_path}
...
then
    ...
    do
        ...
        do
            ...
            python $swap -m ${map} -n ${nside} -s main starg -c ${cap} --method nn_pnllwnstarg
        done
    done
fi
