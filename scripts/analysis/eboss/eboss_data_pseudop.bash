...
samples="maindnnps" # options are lowmidhighz mainhighz
table_name="ngalw_eboss"
...
then
    ...
    do
        ...
        python $prep -d ${dat} -r ${ran} -s ${templates} -o ${output_path} -n ${nside} -sl ${slices} --label ngalw        
    done
fi
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_dnnps_${map}/hp/
                echo ${output_path}
                python $nnfit -i ${input_path} -o ${output_path} -ax ${axes} --nn_structure ${nn_structure[@]} --loss pnll --model dnnps -fl
            done
        done
    done
fi
...
then
    ...
    do
        ...
        do
            ...
            python $swap -m ${map} -n ${nside} -s main dnnps -c ${cap} --method nn_dnnps
