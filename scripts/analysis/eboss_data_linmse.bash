...
samples="mainlinmse" # options are lowmidhighz mainhighz
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_linmse_${map}/hp/
                echo ${output_path}
                python $nnfit -i ${input_path} -o ${output_path} -ax ${axes} -fl --loss mse --model lin
            done
        done
    done
fi
    ...
    do
        ...
        do
            ...
            do
                ...
                output_path=${input_dir}nn_linmse_${map}
                echo ${output_path}
                python $nnfit -i ${input_path} -o ${output_path} -ax ${axes} -lr ${lr} --nn_structure ${nn_structure[@]} -ne $nepoch -nc $nchains -k --loss mse --model lin
            done
        done
    done
fi
...
then
    ...
    do
        ...
        do
            ...
            python $swap -m ${map} -n ${nside} -s main linmse -c ${cap} --method nn_linmse
