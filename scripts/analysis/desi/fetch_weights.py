...
wsys_path = sys.argv[2] #f'{wsys_dir}sv3nn_{target}_{region_}_256/nn-weights.fits'

#cats_dir = f'{root_dir}sv3_v1/'
cat_path = sys.argv[1] #f'{cats_dir}sv3target_{target}_{region}.fits'

out_path = sys.argv[3] #f'{cats_dir}sv3target_{target}_{region}.fits_MrWsys/wsys_{mversion}.fits'
